...
const AudioPlayer: React.FC<AudioPlayerProps> = ({
  ...
  const [volume, setVolume] = useState<number>(localStorage.getItem('volume') ? parseFloat(localStorage.getItem('volume')!) : 0.1);
  ...
  const handleMuteToggle = () => {
    ...
    setIsMuted(prev => {
      ...
      if (newMuted) {
        ...
        localStorage.setItem('volume', preMuteVolume.toString());
      }
